...
const AvailableContracts = () => {
    ...
    const hasShownInterest = (contract) => {
        ...
        return negotiations.some(n => n.type === 'interest' && n.userId === user.id);
    };
        ...
        <div className="min-h-screen bg-gray-50 py-8">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="flex justify-between items-center mb-8">
                    <div>
                        <h1 className="text-3xl font-bold text-gray-900">Available Contracts</h1>
                        <p className="text-gray-600">Browse and show interest in farming contracts</p>
                    </div>
                    <button
                ...
                {showFilters && (
                    <div className="bg-white rounded-lg shadow-md p-6 mb-6">
                        <h2 className="text-xl font-semibold text-gray-900 mb-4">Filter Contracts</h2>
                        ...
                        <div className="flex justify-end gap-3 mt-4">
                            <button onClick={clearFilters} className="px-4 py-2 border border-gray-300 rounded-lg text-gray-700 hover:bg-gray-50">
                                Clear Filters
                            </button>
                ...
                {contracts.length === 0 ? (
                    <div className="bg-white rounded-lg shadow-md p-6">
                        <div className="text-center py-12">
                            ...
                            <h3 className="text-xl font-semibold text-gray-900 mb-2">No Contracts Available</h3>
                    ...
                    <div className="grid grid-cols-1 gap-6">
                        {contracts.map(contract => (
                            <div key={contract.id} className="bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow overflow-hidden">
                                <div className="p-6">
                                        ...
                                        <div className="flex-1">
                                            ...
                                            {contract.farm && (
                                                <div className="flex items-center text-gray-600 text-sm mb-2">
                                                    ...
                                                    <span>
                                                        ...
                                                        {contract.farm.tehsil && `, ${contract.farm.tehsil.tehsil_name}`}
                                                        {contract.farm.block && `, ${contract.farm.block.block_name}`}
                                                    </span>
                                                </div>
                                            )}
                                            ...
                                            {contract.user && (
                                                <div className="flex items-center text-gray-600 text-sm">
                                                    ...
                                                    <span className="ml-2">{contract.user.full_name}</span>
                                                </div>
                                            )}
                                        </div>
                                    </div>
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                                        ...
                                        <div>
                                            ...
                                            <p className="font-medium text-gray-900">
                                                {contract.cropDetails?.quantity?.amount || contract.crop_quantity_amount}{' '}
                                                {contract.cropDetails?.quantity?.unit || contract.crop_quantity_unit}
                                            </p>
                                            <p className="text-sm text-gray-500 capitalize">
                                                {contract.cropDetails?.quality || contract.commodity_quality} grade
                                            </p>
                                        </div>
                                    ...
                                    <div className="mt-6 pt-6 border-t border-gray-200 flex justify-between items-center">
                                        <Link
                                            to={`/trader/contracts/${contract.id}`}
                                        ...
                                        {hasShownInterest(contract) ? (
                                            ...
                                            <button
                                                onClick={(e) => {
                                                    e.preventDefault();
                                                    handleShowInterest(contract.id);
                                                }}
