...
const ContractDetails = () => {
    ...
    const getInterestedTraders = () => {
        ...
        return negotiations.filter(n => n.type === 'interest' && n.status === 'pending');
    };
    ...
    const getStatusIcon = (status) => {
        switch (status) {
            case 'open': return <FaClock className="text-blue-600" />;
            case 'accepted':
            case 'active': return <FaCheckCircle className="text-green-600" />;
            case 'disputed': return <FaExclamationTriangle className="text-red-600" />;
            default: return <FaClock className="text-gray-600" />;
        }
    };

    const canEdit = () =>
        contract && ['draft', 'open'].includes(contract.contract_status || contract.contractStatus);

    const canCancel = () =>
        contract && !['active', 'completed', 'cancelled'].includes(contract.contract_status || contract.contractStatus);
            ...
            <div className="min-h-screen bg-gray-50 py-8">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="bg-white rounded-lg shadow-md p-6">
                        ...
                        <Link to="/contracts" className="text-green-600 hover:underline mt-4 inline-block">
                            ← Back to Contracts
                        </Link>
                    </div>
                </div>
    ...
    const contractData = contract.cropDetails ? contract : {
    ...
    return (
        <div className="min-h-screen bg-gray-50 py-8">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                {/* HEADER */}
                <div className="mb-6">
                    <Link to="/contracts" className="text-green-600 hover:text-green-700 inline-flex items-center mb-4">
                    ...
                    <div className="flex justify-between items-start">
                        <div>
                            <div className="flex items-center gap-3 mb-2">
                                ...
                                <span className={`px-3 py-1 rounded-full text-sm font-medium capitalize flex items-center gap-2 ${getStatusColor(contractData.contractStatus)}`}>
                        ...
                        <div className="bg-white rounded-lg shadow-md p-6">
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <p className="text-lg font-medium text-gray-900">
                                        {new Date(contractData.farmingDetails.plantingDate).toLocaleDateString()}
                                    </p>
                                </div>
                                ...
                                <div>
                                    ...
                                    <p className="text-lg font-medium text-gray-900">
                                        {new Date(contractData.farmingDetails.harvestingDate).toLocaleDateString()}
                                    </p>
                                </div>
                            ...
                            {contractData.farmingDetails.farmingTechniques?.length > 0 && (
                                <div className="mt-4 pt-4 border-t border-gray-200">
                                    <p className="text-sm text-gray-600 mb-2">Farming Techniques</p>
                                    <div className="flex flex-wrap gap-2">
                                        {contractData.farmingDetails.farmingTechniques.map((technique, idx) => (
                                            <span
                                                key={idx}
                            ...
                            {contractData.farmingDetails.irrigationSchedule && (
                                <div className="mt-4">
                                    <p className="text-sm text-gray-600 mb-2">Irrigation Schedule</p>
                                    <p className="text-sm text-gray-900">
                                        {contractData.farmingDetails.irrigationSchedule}
                                    </p>
                                </div>
                        ...
                        <div className="bg-white rounded-lg shadow-md p-6">
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <p className="text-lg font-medium text-gray-900">
                                        ₹{contractData.pricing.basePrice} {contractData.pricing.priceUnit}
                                    </p>
                                </div>
                                ...
                                <div className="mt-4 pt-4 border-t border-gray-200">
                                    ...
                                    <div className="grid grid-cols-2 gap-4">
                                        <div>
                                            ...
                                            <p className="font-medium text-gray-900">₹{contractData.pricing.advancePayment.amount}</p>
                                        </div>
                                        ...
                                        {contractData.pricing.advancePayment.dueDate && (
                                            <div>
                                                ...
                                                <p className="font-medium text-gray-900">
                                                    {new Date(contractData.pricing.advancePayment.dueDate).toLocaleDateString()}
                                                </p>
                                            </div>
                                        )}
                                    ...
                                    <div className="grid grid-cols-2 gap-4">
                                        ...
                                        {contractData.pricing.finalPayment.dueDate && (
                                            <div>
                                                <p className="text-sm text-gray-600">Due Date</p>
                                                <p className="font-medium text-gray-900">
                                                    {new Date(contractData.pricing.finalPayment.dueDate).toLocaleDateString()}
                                                </p>
                                            </div>
                                        )}
                                    </div>
                        ...
                        <div className="bg-white rounded-lg shadow-md p-6">
                            ...
                            <div className="space-y-3">
                                ...
                                {contractData.logistics.packagingRequirements && (
                                    <div>
                                        <p className="text-sm text-gray-600">Packaging Requirements</p>
                                        <p className="font-medium text-gray-900">
                                            {contractData.logistics.packagingRequirements}
                                        </p>
                                    </div>
...
5.824 3 7.938l3-2.647z"
                                    ...
                                    <p className="text-xs text-gray-500 mt-4 text-center">
                                        Accepting a trader will move the contract to negotiating phase
                                    </p>
                                </div>
                            )}
