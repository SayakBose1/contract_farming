            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="flex justify-between items-center mb-8">
                    <div>
                        ...
                        <p className="text-gray-600">Manage your farms and create contracts</p>
                    </div>

                    <Link to="/farmer/farms/create" className="btn-primary inline-flex items-center">
                ...
                {farms.length === 0 ? (
                    <div className="bg-white rounded-lg shadow-md p-6">
                        <div className="text-center py-12">
                            ...
                            <h3 className="text-xl font-semibold text-gray-900 mb-2">No Farms Added Yet</h3>
                            <p className="text-gray-600 mb-6">
                                Add your first farm to start creating contracts and connecting with buyers.
                            </p>
                                    ...
                                    <div className="p-6">
                                        ...
                                        <div className="space-y-2 text-sm text-gray-600">
                                            ...
                                            <div className="flex items-center">
                                                ...
                                                <span>{districtName}, {divisionName}</span>
                                            </div>
